...
/**
 * @category    GuruTheme
 * @package     GuruTheme_Ajaxlogin
 * @copyright   Copyright (c) 2012 Gurutheme.com (http://gurutheme.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
require_once Mage::getModuleDir('controllers', 'Mage_Customer').DS.'AccountController.php';
class Gurutheme_Ajaxlogin_AccountController extends Mage_Customer_AccountController
{
      ...
      protected $_customActions = array('guruthemeLogin','guruthemeCreate','guruthemeForgotPass');
	...
	public function guruthemeLoginAction(){
     ...
     * Login post action
     */
    public function guruthemeCreateAction()
    {
        $session = $this->_getSession();
		...
		if ($this->getRequest()->isPost()) {
			...
			try {
				...
				if ($e->getCode() === Mage_Customer_Model_Customer::EXCEPTION_EMAIL_EXISTS) {
					$url = Mage::getUrl('customer/account/forgotpassword');
					$response['success'] = false;
					$response['message'] = $this->__('There is already an account with this email address. If you are sure that it is your email address, <a href="%s">click here</a> to get your password and access your account.', $url);
