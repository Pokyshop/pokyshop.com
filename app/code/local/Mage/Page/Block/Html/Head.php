...
class Mage_Page_Block_Html_Head extends Mage_Core_Block_Template
{
    ...
    public function getCssJsHtml()
    {
        ...
        foreach ($lines as $if => $items) {
            ...
            // static and skin css
			$cssVersionNumber = Mage::helper('sarah')->getCssVersion();	//	S:VA	Css Versioning
			$html .= $this->_prepareStaticAndSkinElements('<link rel="stylesheet" type="text/css" href="%s?v='.$cssVersionNumber.'"%s />'."\n",
			...
			$jsVersionNumber = Mage::helper('sarah')->getJsVersion();	//	S:VA	Js Versioning
            $html .= $this->_prepareStaticAndSkinElements('<script type="text/javascript" src="%s?v='.$jsVersionNumber.'"%s></script>' . "\n",
